...
int (*action_handler[])(hip_common_t *, int action,const char *opt[], int optc, int send_only) =
{
	...
	NULL,						/* 14: TYPE_GW, was hip_conf_handle_gw */
	NULL,						/* 15: TYPE_GET, was hip_conf_handle_get */
	...
	NULL,						/* 21: TYPE_SET, was hip_conf_handle_set */
	NULL,						/* 22: TYPE_DHT, was hip_conf_handle_dht_toggle */
