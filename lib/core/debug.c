...
/**
 * The libraries read from hipd configuration file what logging messages to display
 *
 * @param cfile   pointer that contains the name of the hipd configuration file.
