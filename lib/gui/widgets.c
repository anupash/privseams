...
/**
 * widget_init - Initialize GUI widgets system. This system stores pointers to
 *               widgets in use.
 *
...
int widget_init(void)
{
    ...
    /* had to call calloc here to avoid the following error
    ...
    gui_widgets = calloc(WIDGET_IDS_N, sizeof(void *));
...
/**
 * widget_set - Set pointer for given widget. This function set's pointer of
 *              given widget ID. This ID should be declared in widgets.h
 *              enum WIDGET_IDS.
 *
