...
#define HIP_WO_SUBTYPE_RECV_REA     5
#define HIP_WO_SUBTYPE_RECV_AC      6
#define HIP_WO_SUBTYPE_RECV_ACR     7
...
#define HIP_WO_SUBTYPE_NEWDH      208 // request new DH-key (implies NES)
...
struct hip_work_order *hip_create_job_with_hit(int mask, struct in6_addr *hit);
