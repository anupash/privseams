...
% XX FIX MIKA:
% - add description of the missing hooks (DAD, what else did you add? esp?)
%
% ks. ed.
...
% XX FIX Mika
% - update the text to cover the new mm mechism and remove old stuff
% - tell more about the CURRENT implementation
%   - changes in the hadb
%   - SA pair / interface (was previously SA pair / host)
%   - ESP changes
...
% XX FIX: Mika
% - the about the difficulties in the implementation
%   - what was difficult in the old mm draft to implement?
%   - what was difficult in the new mm draft to implement?
% - was something easy to implement?
...
%The implementation for mobility and multihoming support is at a highly
