...
/*
 * Stuff for performance val.
 */
#include "lib/core/performance.h"
#include "lib/core/debug.h"
#include "lib/core/filemanip.h"

#define PERF_BLACKBOX 0
...
#ifdef CONFIG_HIP_PERFORMANCE
    HIP_DEBUG("Start PERF_BLACKBOX\n");  // test 1.1.1
    hip_perf_start_benchmark(set, PERF_BLACKBOX);
#endif
      /*
...
#ifdef CONFIG_HIP_PERFORMANCE
    HIP_DEBUG("Stop PERF_BLACKBOX\n");
    hip_perf_stop_benchmark(set, PERF_BLACKBOX);
    hip_perf_write_benchmark(set, PERF_BLACKBOX);
#endif
   /*
   ** Clean up & return.
   */
