...
# PISA configuration
compile --enable-firewall --disable-agent --disable-pfkey --disable-rvs --disable-hipproxy --disable-i3 --disable-opportunistic --disable-dht --disable-blind --disable-profiling --enable-debug --enable-midauth --disable-performance --disable-demo

# Alternative path to vanilla
compile --enable-firewall --enable-agent --enable-pfkey --disable-rvs --disable-hipproxy --enable-i3 --disable-opportunistic --disable-dht --enable-blind --enable-profiling --disable-debug --enable-midauth --enable-performance --enable-demo
