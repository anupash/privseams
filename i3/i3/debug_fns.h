 ...
 */
      ...
      #define I3_PRINT_DEBUG(debugLevel, ... ) if (debugLevel <= I3_CURRENT_DEBUG_LEVEL) \
 ...
 */
   ...
   #if 0
      #define I3_PRINT_INFO(infoLevel, msg, ...) if (infoLevel <= I3_CURRENT_INFO_LEVEL) \
        printf(msg, ## __VA_ARGS__)
   #endif

   #define I3_PRINT_INFO(infoLevel, ... ) if (infoLevel <= I3_CURRENT_INFO_LEVEL) \
