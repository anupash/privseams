 ...
 *
 * Functions to manipulate the HIT database and do searcher from it. Also contains the functionality
 * that inserts the records from memory to sqlite3 database. 
 *
...
/**
 * hip_agent_db_local_callback - Callback function to get the data from the db table local
 *
...
/**
 * hip_agent_db_remote_callback - Callback function to get the data from the db table remote
 *
 * @param NotUsed Not used
 * @param argc How many arguments
 * @param argv Arguments
...
/**
 * hip_agent_db_groupts_callback - Callback function to get the data from the db table groups
 *
 * @param NotUsed Not used
 * @param argc How many arguments
 * @param argv Arguments
 ...
 **/
HIT_Remote *
hit_db_add_hit(HIT_Remote *hit, int nolock)
{
...
*/
HIT_Remote *
hit_db_add(char *name, struct in6_addr *hit, char *url,
 ...
 **/
HIT_Remote *
hit_db_find(char *name, struct in6_addr *hit)
{
	HIT_Remote *r;
	int err;
 ...
 **/
static int 
hit_db_load_from_file(char *file)
{
        FILE * db_file = NULL;
	int err = 0;
        extern sqlite3 * agent_db;
 ...
 **/
HIT_Group *
hit_db_find_rgroup(const char *name)
{
	HIT_Group *g;
 ...
 **/
HIT_Local *
hit_db_add_local(char *name, struct in6_addr *hit)
{
 ...
 **/
HIT_Local *
hit_db_find_local(char *name, struct in6_addr *hit)
{
	HIT_Local *h;
	int err;
