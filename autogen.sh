...
display_dependencies() {
	...
	then
	echo "apt-get install tla autoreconf automake autoconf libtool g++ libgtk2.0-dev libssl-dev libxml2-dev xmlto doxygen iproute netcat6 iptables-dev libcap-dev libsqlite3-dev uuid-dev miredo libnet-ip-perl libinet-dns-perl libsocket6-perl libio-socket-inet6-perl"
