...
#define SO_HIP_PARAM_LSI			139
#define SO_HIP_GET_LSI_PEER                     140
#define SO_HIP_GET_LSI_OUR			141
#define SO_HIP_IS_OUR_LSI                       142
#define SO_HIP_ADD_PEER_MAP_HIT_IP_LSI          143
/** @} */
/* inclusive */
